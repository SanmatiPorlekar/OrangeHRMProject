...
//	------------------------------------------------------------------------------------------
	...
	//Admin Qualification->Skill Methods
	 ...
	 public void setDriver(WebDriver driver) {
		...
		public void setSkillEditName(String name) {
		...
		public void setSkillEditDescription(String description) {
			Actions a=new Actions(driver);
	 ...
	 //--------------------------------------------------------------
		...
		public void setEducationEditName(String name) {
		...
		public void setNationalEditName(String name) {
